...
mongoose.connect('mongodb://localhost/'); //what does this line do?
...
var read = function(name,callback) { // what is this callback doing here?
...
var update = function(name, content) {
    Snippet.findOneAndUpdate({name: name}, {content: content}, function(err, snippet) {//how is the err and snippet plugged into callback?
        if (err || !snippet) {
